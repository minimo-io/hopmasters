  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      _beerFuture!.then((beerData) {
        refreshScore(
            int.parse(beerData!.scoreCount!), double.parse(beerData.scoreAvg!));
      });
    });
  }
          ...
          switch (snapshot.connectionState) {
            ...
            default:
              if (snapshot.hasError)
                ...
                return Scaffold(
                  floatingActionButton: (_hideCommentsFloatingButtons == false
                      ? OpinionFloatingAction("PUBLICAR", "OPINAR",
                          title: "OPINAR",
                          //height: 430,
                          ...
                          updateParentScore: refreshScore, onTap: () {
                          setState(() {
                      ...
                      : Padding(
                          ...
                          child: FloatingActionButton.extended(
                              ...
                              backgroundColor:
                                  snapshot.data.rgbColor.withOpacity(0.95),
                              label: Text("X",
                                  style: TextStyle(
